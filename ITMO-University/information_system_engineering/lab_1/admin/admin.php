...
<body id="first">
    ...
    <input class="btn btn-primary" onclick="return myFunction2()" type="submit" value="Вернуться на регистрацию" name="reg" style=" margin-left: 43%; margin-bottom: 30px; width:230px" ;>
